...
<div class="card" style="max-width:720px;margin:0 auto;">
    <div class="card-h">
        <div>
            <h3>Editar Empresa: <span style="color:var(--accent-ink)">{{ $company->name }}</span></h3>
    ...
    <form action="{{ route('management.companies.update', $company->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="card-b" style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
            ...
            <div class="field" style="grid-column:1/-1;">
                ...
                <input type="text" id="name" name="name"
                       ...
                       value="{{ old('name', $company->name) }}" placeholder="Nombre de la empresa" />
            ...
            <div class="field">
                ...
                <input type="text" id="rfc" name="rfc"
                       ...
                       value="{{ old('rfc', $company->rfc) }}" placeholder="RFC (máx. 13 caracteres)" maxlength="13" />
            ...
            <div class="field">
                ...
                <input type="text" id="phone" name="phone"
                       ...
                       value="{{ old('phone', $company->phone) }}" placeholder="+52 55 0000 0000" maxlength="20" />
            ...
            <div class="field">
                ...
                <select id="status_id" name="status_id" class="select {{ $errors->has('status_id') ? 'is-invalid' : '' }}">
                    <option value="1" {{ old('status_id', $company->status_id) == 1 ? 'selected' : '' }}>Activo</option>
                    <option value="2" {{ old('status_id', $company->status_id) == 2 ? 'selected' : '' }}>Inactivo</option>
                </select>
